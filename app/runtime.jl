...
try
  println("TRYING")
  global lambda_runtime_api = ENV["AWS_LAMBDA_RUNTIME_API"]
catch e
  global lambda_runtime_api = "api_goes_here"  
end

endpoint = "$(lambda_runtime_api)/2018-06-01/runtime/invocation/"
...
HTTP.@register(ANIMAL_ROUTER, "GET", "/*", getAnimal)
...
HTTP.serve(ANIMAL_ROUTER, ip"0.0.0.0", 8080)
